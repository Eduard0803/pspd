...
int main(int argc, char *argv[]) {
	...
	sprintf(OUTFILE, "julia_fractal_%d_%d.bmp", rank, nprocs);
	printf("%d/%d | OUTFILE: %s\n", rank, nprocs, OUTFILE);
	...
	printf("%d/%d | Computando linhas de pixel %d até %d, para uma área total de %d\n", rank, nprocs, 0, n-1, area);
